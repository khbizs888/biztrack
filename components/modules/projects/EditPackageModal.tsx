...
interface Props {
  ...
  onClose: () => void
  pkg: Package | null
  onSave: (data: { name: string; code: string; price: number; notes?: string; customValues?: Record<string, string> }) => void
}

export default function EditPackageModal({ open, onClose, pkg, onSave }: Props) {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    onSave({ name: trimName, code: trimCode, price: parsedPrice, notes: notes.trim() || undefined, customValues: pkg?.customValues })
